...
export const experienceList: Array<Experience> = [
	{
		...
		imageUrl:
			'https://adam-pavlik-assets.s3.eu-central-1.amazonaws.com/company-logos/dataart_logo.jpg',
		description:
			'Developing and maintaining a highly scalable investment platform for one of the largest investment providers in Britain. Specializing in solution architecture and software development, ensuring high availability, security, and performance for pension funds and personal investment solutions.',
		achievements: [
		...
		skills: ['Solution Architecture', 'Java', 'Spring Framework', 'AWS', 'Microservices']
	},
	{
		title: 'Senior Software Developer',
		company: 'Luxoft',
		...
		imageUrl:
			'https://adam-pavlik-assets.s3.eu-central-1.amazonaws.com/company-logos/luxoft_logo.jpg',
		description:
			'Designed and developed a high-frequency trading platform for the banking sector, ensuring low-latency and high-throughput performance. Worked on complex, highly loaded systems requiring expertise in concurrency, distributed systems, and real-time data processing.',
		achievements: [
		...
		skills: ['Solution Architecture', 'Java', 'Kafka', 'Solace', 'Concurrency']
	},
	{
		...
		imageUrl:
			'https://adam-pavlik-assets.s3.eu-central-1.amazonaws.com/company-logos/epam_systems_logo.jpg',
		description:
			'Developed and integrated business process automation solutions for the healthcare sector, ensuring efficiency, scalability, and reliability in hospital operations. Designed and implemented enterprise-grade integration systems, streamlining data flow across multiple healthcare providers.',
		achievements: [
		...
		skills: ['Business Process Management Systems', 'Business Event Management Systems', 'Java']
	},
	{
		...
		imageUrl:
			'https://adam-pavlik-assets.s3.eu-central-1.amazonaws.com/company-logos/softserve_logo.jpg',
		description:
			'Developed and modernized an exams platform for education, used by universities in Utah, ensuring scalability, performance, and reliability. Led the migration of a legacy system to AWS serverless architecture, improving efficiency and reducing operational costs.',
		achievements: [
	...
	},
	{
		...
		imageUrl:
			'https://adam-pavlik-assets.s3.eu-central-1.amazonaws.com/company-logos/inventorsoft_co_logo.jpg',
		description:
			'Developed and maintained an accounting platform for the banking sector, ensuring seamless integration with financial systems. Worked on full-stack development using Java (Spring) and Angular, focusing on performance, security, and scalability.',
		achievements: [
